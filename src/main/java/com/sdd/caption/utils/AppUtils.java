...
public class AppUtils {
	...
	public final static String STATUS_ORDER_WAITAPPROVAL = "001";
	public final static String STATUS_ORDER_DECLINE = "002";
	public final static String STATUS_ORDER_OUTGOINGAPPROVAL = "003";
	public final static String STATUS_ORDER_OUTGOINGDECLINE = "004";
	public final static String STATUS_ORDER_PRODUKSI = "005";
	public final static String STATUS_ORDER_DONE = "006";
	public final static String STATUS_ORDER_WAITSCANPRODUKSI = "007";
	public final static String STATUS_ORDER_REQUESTORDER = "008";
	public final static String STATUS_ORDER_WAITAPPROVALOPR = "009";
	...
	public final static String STATUS_REPAIR_WAITAPPROVAL = "P1";
	public final static String STATUS_REPAIR_WAITAPPROVALREPAIROPR = "P2";
	public final static String STATUS_REPAIR_DECLINEAPPROVAL = "P3";
	public final static String STATUS_REPAIR_APPROVALREPAIROPR= "P4";
	public final static String STATUS_REPAIR_DECLINEREPAIROPR = "P5";
