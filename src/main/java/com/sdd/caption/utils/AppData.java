...
public class AppData {
	...
	public static String getStatusLabel(String code) {
		...
		else if (code.trim().equals(AppUtils.STATUS_ORDER_DECLINE))
			return "DECLINE BY PEMIMPIN";
		else if (code.trim().equals(AppUtils.STATUS_ORDER_OUTGOINGAPPROVAL))
			return "WAIT APPROVAL OUTGOING";
		...
		// STATUS PLANNING
			...
			return "WAIT APPROVAL PEMIMPIN/UNIT";
		...
		// STATUS SWITCHING
			...
			return "REJECTED BY CABANG TUJUAN";
		else
			return code;
	}
