...
public class EmbossProductVm {
	...
	@AfterCompose
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, @ExecutionArgParam("obj") Tembossfile obj)
	...
	public void doSearch() {
		filter = "tembossfilefk = " + obj.getTembossfilepk();
	...
	public Tembossfile getObj() {
		return obj;
	}

	public void setObj(Tembossfile obj) {
		this.obj = obj;
	}
