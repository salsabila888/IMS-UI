	...
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view) {
		...
		if (listbox != null) {
			listbox.setItemRenderer(new ListitemRenderer<Mpicproduct>() {
				...
				@Override
				public void render(Listitem item, final Mpicproduct data, int index)
						throws Exception {
