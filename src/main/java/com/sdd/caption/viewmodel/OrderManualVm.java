...
//				FlowHandler.doFlow(session, null, objForm, AppUtils.PROSES_ORDER, objForm.getMemo(), oUser.getUserid());
				...
				Mmenu menu = new MmenuDAO().findByFilter("menupath = '/view/order/orderapproval.zul' and menuparamvalue = '" + productgroup +"'");
				if(menu != null)
					NotifHandler.doNotif(session, menu,
							"data order " + AppData.getProductgroupLabel(productgroup) + " baru dimenu");
